### Script to compute null model scores for DFIM interaction scores
### Peyton Greenside
### 2/14/18

### Inputs
# Set of sequences
# Indices (seq, start, end) of mutation
# Indices (seq, start, end) of response
# deeplift function
...
def generate_dfim_null_distribution(mut_loc_dict, deeplift_func,
    ...
    # Compute Importance on shuf sequences
    # Call DeepLIFT function on shuf sequences

    # Compute DFIM scores (call DFIM)
    # Look at interaction between mut and response location
